...
async function connectToWA() {
  ...
  console.log("Connecting ❤️𝚁_𝙰_𝙽_𝚄❤️");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("❤️𝚁_𝙰_𝙽_𝚄❤️ installed successful ✅");
      console.log("❤️𝚁_𝙰_𝙽_𝚄❤️ connected to whatsapp ✅");

      let up = `❤️𝚁_𝙰_𝙽_𝚄❤️ connected successful ✅`;
      let up1 = `Hello RANU-MD, I made bot successful`;
...
app.get("/", (req, res) => {
  res.send("hey, ❤️𝚁_𝙰_𝙽_𝚄❤️ started✅");
});
app.listen(port, () =>
